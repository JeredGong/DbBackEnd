...
pub async fn Register(
    ...
    // Insert a new user
    sqlx::query!("INSERT INTO \"user\" (id, username, password_hash, role) VALUES ($1, $2, $3, $4)", 
        6, &regInfo.username, &regInfo.password_hash, &regInfo.role) // TODO: Fix id as primary key.
